...
function main() {
  var url = 'https://dash.adjust.com/control-center/reports-service/csv_report?cost_mode=network&metrics=installs';
  ...
  fetchDataAndWriteToSheet(url, bearerToken, appTokenIn, datePeriod, dimensions, targetSheetId, targetSheetName);
}

function fetchDataAndWriteToSheet(url, bearerToken, appTokenIn, datePeriod, dimensions, targetSheetId, targetSheetName) {
